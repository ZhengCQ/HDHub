  ...
  <section>
    <div class="container">
      <nav class="navbar navbar-default navbar-expand-md fixed-top navbar-dark bg-dark" role="navigation" style="margin-bottom: 20px;">
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse" style="margin-left: 30px;">
...
export default {
  name: 'Navar' // this is the name of the component
}
